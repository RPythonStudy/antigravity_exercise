...
- 아래 순서대로 실습을 진행하며 Antigravity의 기능을 체험해 보세요.
   - **설치 파일 다운로드**: 공식 사이트 접속 및 다운로드.
   - **설치**: 프로그램 설치 완료.
   - **구글 계정 로그인**: 인증 절차 완료.
   - **프로젝트 폴더 열기**: Antigravity에서 실습할 프로젝트 폴더 열기.
- 프롬프트를 이용한 실습
   - **파이썬 경로 확인하기 (터미널 활용 예시)**
      - `01_프롬프트-파이썬경로.txt`
   - 파이썬 **가상환경(.venv) 활성화하기**
      - `02_프롬프트-파이썬가상환경.txt`
   - **웹사이트 크롤링하기 (브라우저 활용 예시)**
       - `03_프롬프트-웹사이트크롤링.txt` 
   - **그래프 그리기**
       -`04_프롬프트-그래프그리기.txt`
- 추가적인 실습: 시간이 가용하다면 R을 이용한 그래프 그리기를 해 봅니다.
   -  시스템에 설치된 R의 경로를 확인하기
      - ` 05_프롬프트-R경로.txt`
   - 시스템R에 renv 패키지 설치하기
       - ` 06_프롬프트-renv 설치하기.txt`
   -  프로젝츠 폴더의 renv 초기화
      - ` 07_프롬프트-renv초기화.txt`
   - R로 그래프 그리기
       ` 08_프롬프트-R그래프.txt`
